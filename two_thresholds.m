...
lowerThreshold = 0.4; % Adjust this value as needed
upperThreshold = 0.6; % Adjust this value as needed

% Threshold the image
binaryImage = (grayImage >= lowerThreshold) & (grayImage <= upperThreshold);
